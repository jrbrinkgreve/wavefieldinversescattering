...
for rot = 0:3     %deg = [0 90 180 270] rotations
fprintf('Rotation %d / 4\n', rot+1);
image = rot90(image_original, rot);

% Q10/11
M_per_array = 10; %per array! more in total
...
colorbar()
title(['Tikhonov + rotated illumination + DWBI reconstruction, \lambda = ' num2str(lambda)])
axis equal tight
